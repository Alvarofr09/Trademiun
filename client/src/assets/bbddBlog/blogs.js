import oro from "../img/WebBlog/oro.jpg";
import bitcoin from "../img/WebBlog/bitcoin.jpg";
import petroleo from "../img/WebBlog/petroleo.jpg";
import ethereum from "../img/WebBlog/ethereum.jpg";
import amazon from "../img/WebBlog/amazon.jpg";
import apple from "../img/WebBlog/apple.jpg";
const blogs = [
  {
    id: 1,
    img: oro,
    titulo: "El precio del Oro apunta a máximos históricos",
    descripcion:
      "El precio del Oro se disparó durante la sesión norteamericana previa al fin de semana, ya que el par XAU/USD cotizó por encima de 2.400$...",
    fecha: "17-05-2024",
    enlace:
      "https://www.fxstreet.es/news/el-precio-del-oro-supera-el-nivel-2400-apunta-a-maximos-historicos-202405172003",
  },
  {
    id: 2,
    img: bitcoin,
    titulo: "Bitcoin alcanza los 60,000$ nuevamente",
    descripcion:
  ...
  },
  {
    ...
    img: amazon,
    titulo:
      "Las acciones de Amazon suben un 10% tras el anuncio de nuevas inversiones",
    descripcion:
