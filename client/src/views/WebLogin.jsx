          ...
          >
            ...
            <div className="px-4 py-3">
              <svg
                ...
                className="icon icon-tabler icons-tabler-outline icon-tabler-brand-facebook h-6 w-6"
              >
            ...
            <div className="px-4 py-3">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="icon icon-tabler icons-tabler-outline icon-tabler-brand-apple h-6 w-6"
              >
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
