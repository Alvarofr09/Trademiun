...
const WebPagos = () => {
	return (
		<div className="container dark:bg-primario dark:text-white">
			<div className="py-8 basis-8/12">
				...
				<div className=" bordered w-[70%] mx-auto p-2 m-8 flex ">
					<div className="flex flex-col basis-1/3">
						<p className="text-center font-bold py-4 dark:text-white">
							Introducir retiro
						</p>
						<input
					...
					<div className="flex flex-col basis-2/3 ">
						<p className="text-center py-4 font-bold dark:text-white">
							Métodos de pago
						</p>

						<div className="flex justify-around">
							<button className="font-bold border-solid  border-2 dark:border-white border-primario dark:text-white p-2 px-8 rounded-md ">
								Crypto
							</button>
							<button className="font-bold border-solid  border-2 dark:border-white border-primario dark:text-white p-2 px-8 rounded-md">
								Banco
							</button>
							<button className="font-bold border-solid  border-2 dark:border-white border-primario dark:bg-white bg-primario p-2 px-8 rounded-md dark:text-primario text-white">
								Solicitar
							</button>
						</div>
					</div>
